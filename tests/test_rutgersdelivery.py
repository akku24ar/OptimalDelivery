...
def test_get_coordinate_location():
    locations = ['Food Distribution Hub', 'Tacoria', 'Halal Guys', 'Hansel n Griddle', 'Truck Depot']
    expectedResult = {'Food Distribution Hub': 0, 'Tacoria': 1, 'Halal Guys': 2, 'Hansel n Griddle': 3, 'Truck Depot': 4}
...
def test_insert_dummy1(): # Normal Case
    ...
    coordinateLocations = {'Food Distribution Hub': 0, 'Tacoria': 1, 'Halal Guys': 2, 'Truck Depot': 3}
    loc = [(0, 1, 2), (0, 2, 3), (0, 3, 10), (1, 2, 1), (1, 3, 8), (2, 3, 7)]
    expectedResult = [(0, 1, 2), (0, 2, 3), (0, 3, 10), (1, 2, 1), (1, 3, 8), (2, 3, 7), (0, 4, 0.1), (1, 4, 100000), (2, 4, 100000), (3, 4, 0.1)]
...
def test_get_correct_order1(): # Else If Branch
    ...
    correctValue = [0, 1, 2]
    assert correctValue == get_correct_order(route,last,indexes, coordinateMap)
...
def test_get_correct_order2(): # If Branch
    ...
    last = 5
    indexes = {'Food Distribution Hub': 0, 'Tatas Pizza': 1, 'Tacoria': 2, 'Hansel n Griddle': 3, 'Halal Guys': 4, 'Truck Depot': 5}
...
def test_get_correct_order3(): # Else Branch
    ...
    last = 6
    indexes = {'Food Distribution Hub': 0, 'Tacoria': 1, 'Halal Guys': 2, 'Hansel n Griddle': 3, 'Tatas Pizza': 4, 'Judys Kitchen': 5, 'Truck Depot': 6}
...
def test_convert_route_to_coordinates():
    coordinateMap = {"Food Distribution Hub": (5, 5),
                 ...
                 "Cook Douglass Student Center": (9, 2),
                 "Truck Depot": (10, 10)}  
    routeInfo = ['Food Distribution Hub', 'Tacoria', 'Halal Guys', 'Hansel n Griddle', 'Truck Depot']
    coordinateRoute = {'Food Distribution Hub': (5, 5), 'Tacoria': (6, 6), 'Halal Guys': (6, 7), 'Hansel n Griddle': (7, 8), 'Truck Depot': (10, 10)} 
    assert coordinateRoute == convert_route_to_coordinates(routeInfo,coordinateMap)

def test_generate_graph():
    dictLocations = {'Henrys Diner': 0, 'Rutgers Cinema': 1, 'Busch Dining Hall': 2, 'Cook Douglass Student Center': 3, 'Truck Depot': 4}
    coordinateRoute = {'Henrys Diner': (2, 2), 'Rutgers Cinema': (2, 4), 'Busch Dining Hall': (4, 6), 'Cook Douglass Student Center': (9, 2), 'Truck Depot': (10, 10)}
    coordinateGraph = [(0, 1, 2), (0, 2, 6), (0, 3, 7), (0, 4, 16), (1, 2, 4), (1, 3, 9), (1, 4, 14), (2, 3, 9), (2, 4, 10), (3, 4, 9)]
    assert coordinateGraph == generate_graph(dictLocations, coordinateRoute)

def test_get_final_path():
    ordered = ['Henrys Diner', 'Rutgers Cinema', 'Busch Dining Hall', 'Cook Douglass Student Center', 'Truck Depot']
    locationList = ['Henrys Diner', 'Rutgers Cinema', 'Busch Dining Hall', 'Cook Douglass Student Center', 'Truck Depot']
    finalRoute = ['Henrys Diner', 'Rutgers Cinema', 'Busch Dining Hall', 'Cook Douglass Student Center', 'Truck Depot']
    finalDistance = 24
    assert finalRoute, finalDistance == get_final_path(ordered, locationList)

def test_get_shortest_route():
    finalCoordinateGraph = [(0, 1, 2), (0, 2, 3), (0, 3, 5), (0, 4, 8), (0, 5, 6), (0, 6, 5), (0, 7, 10), (1, 2, 1), (1, 3, 3), (1, 4, 6), (1, 5, 4), (1, 6, 3), (1, 7, 8), (2, 3, 2), (2, 4, 5), (2, 5, 3), (2, 6, 2), (2, 7, 7), (3, 4, 3), (3, 5, 1), (3, 6, 2), (3, 7, 5), (4, 5, 2), (4, 6, 3), (4, 7, 2), (5, 6, 3), (5, 7, 4), (6, 7, 5), (0, 8, 0.1), (1, 8, 100000), (2, 8, 100000), (3, 8, 100000), (4, 8, 100000), (5, 8, 100000), (6, 8, 100000), (7, 8, 0.1)]
    routeLength = 9
